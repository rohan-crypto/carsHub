"use client";//using hooks so make component client
  ...
  return (
    <div className="car-card group">
      ...
      <div className="relative w-full mt-2 flex">
        <div className="flex group-hover:invisible w-full text-gray-700 justify-between">
          ...
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <p className="text-[14px]">
              {(city_mpg*0.425144).toFixed(1)} KMPL
            </p>
          </div>
