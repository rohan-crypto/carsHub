...
const SearchManufacturer = 
    ...
    // if query is empty i.e. blank search then show all manufacturers
    // else filter manufacturers based on what user in searching for
    // the regex being used will replace all empty spaces with ""
